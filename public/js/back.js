...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); // JAVASCRIPT PER PERMETTERE NEL REGISTER IL CONTROLLO DEL REQUIRED NELLA SELEZIONE DELLE CATEGORIE


var checkBoxRequired = document.querySelectorAll('.remove-required'); // CALCOLA IL NUMERO DI ELEMENTI SELEZIONATI CON QUERYSELCTORALL

var checkFormLength = checkBoxRequired.length;
checkBoxRequired.forEach(function (checkbox) {
  checkbox.addEventListener("click", function () {
    ...
    checkBoxRequired = document.querySelectorAll('.remove-required'); // CONFRONTA LA LUNGHEZZA INIZIALE CON QUELLA MODIFICATA ED EVENTIUALMENTE RIASSEGNA IL REQUIRED A TUTTI GLI ELEMENTI
...
module.exports = __webpack_require__(/*! C:\MAMP\htdocs\deliveboo\progetto_finale\resources\js\back.js */"./resources/js/back.js");
